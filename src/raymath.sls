(library (raylib raymath (0 2))
  ...
  (define matrix->mat
    (lambda (matrix)
      (let ([m (make-mat 4)])
        (mat-set! m 0 0 (matrix-get matrix m-0))
        (mat-set! m 1 0 (matrix-get matrix m-1))
        (mat-set! m 2 0 (matrix-get matrix m-2))
        (mat-set! m 3 0 (matrix-get matrix m-3))
        (mat-set! m 0 1 (matrix-get matrix m-4))
        (mat-set! m 1 1 (matrix-get matrix m-5)) 
        (mat-set! m 2 1 (matrix-get matrix m-6))
        (mat-set! m 3 1 (matrix-get matrix m-7)) 
        (mat-set! m 0 2 (matrix-get matrix m-8))
        (mat-set! m 1 2 (matrix-get matrix m-9)) 
        (mat-set! m 2 2 (matrix-get matrix m-10))
        (mat-set! m 3 2 (matrix-get matrix m-11))
        (mat-set! m 0 3 (matrix-get matrix m-12))
        (mat-set! m 1 3 (matrix-get matrix m-13)) 
        (mat-set! m 2 3 (matrix-get matrix m-14))
        (mat-set! m 3 3 (matrix-get matrix m-15))
        m)))
