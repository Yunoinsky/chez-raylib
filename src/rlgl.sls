(library (raylib rlgl (0 3))
  (export RL_DEFAULT_SHADER_ATTRIB_LOCATION_INSTANCETRANSFORM
   ...
   RL_DRAW_FRAMEBUFFER RL_READ_FRAMEBUFFER RL_BLEND_COLOR
   RL_BLEND_SRC_ALPHA RL_BLEND_DST_ALPHA RL_BLEND_SRC_RGB
   RL_BLEND_DST_RGB RL_BLEND_EQUATION_ALPHA
   RL_BLEND_EQUATION_RGB RL_BLEND_EQUATION
   RL_FUNC_REVERSE_SUBTRACT RL_FUNC_SUBTRACT RL_MAX RL_MIN
   RL_FUNC_ADD RL_ONE_MINUS_CONSTANT_ALPHA RL_CONSTANT_ALPHA
   RL_ONE_MINUS_CONSTANT_COLOR RL_CONSTANT_COLOR
   RL_SRC_ALPHA_SATURATE RL_ONE_MINUS_DST_COLOR RL_DST_COLOR
   RL_ONE_MINUS_DST_ALPHA RL_DST_ALPHA RL_ONE_MINUS_SRC_ALPHA
   RL_SRC_ALPHA RL_ONE_MINUS_SRC_COLOR RL_SRC_COLOR RL_ONE
   RL_ZERO RL_COMPUTE_SHADER RL_VERTEX_SHADER
   RL_FRAGMENT_SHADER RL_DYNAMIC_COPY RL_DYNAMIC_READ
   RL_DYNAMIC_DRAW RL_STATIC_COPY RL_STATIC_READ RL_STATIC_DRAW
   RL_STREAM_COPY RL_STREAM_READ RL_STREAM_DRAW RL_FLOAT
   RL_UNSIGNED_BYTE RL_QUADS RL_TRIANGLES RL_LINES RL_TEXTURE
   RL_PROJECTION RL_MODELVIEW RL_TEXTURE_WRAP_MIRROR_CLAMP
   RL_TEXTURE_WRAP_MIRROR_REPEAT RL_TEXTURE_WRAP_CLAMP
   RL_TEXTURE_WRAP_REPEAT RL_TEXTURE_MIPMAP_BIAS_RATIO
   RL_TEXTURE_FILTER_ANISOTROPIC RL_TEXTURE_FILTER_MIP_LINEAR
   RL_TEXTURE_FILTER_LINEAR_MIP_NEAREST
   RL_TEXTURE_FILTER_NEAREST_MIP_LINEAR
   RL_TEXTURE_FILTER_MIP_NEAREST RL_TEXTURE_FILTER_LINEAR
   RL_TEXTURE_FILTER_NEAREST RL_TEXTURE_MIN_FILTER
   RL_TEXTURE_MAG_FILTER RL_TEXTURE_WRAP_T RL_TEXTURE_WRAP_S
   RL_MAX_SHADER_LOCATIONS RL_MAX_MATRIX_STACK_SIZE
   RL_DEFAULT_BATCH_MAX_TEXTURE_UNITS
   RL_DEFAULT_BATCH_DRAWCALLS RL_DEFAULT_BATCH_BUFFERS
   RL_DEFAULT_BATCH_BUFFER_ELEMENTS rl-Render-Batch
   make-rl-render-batch copy-rl-render-batch
   rl-render-batch-set! rl-render-batch-get
   rl-render-batch-ref& rl-Draw-Call make-rl-draw-call
   copy-rl-draw-call rl-draw-call-set! rl-draw-call-get
   rl-draw-call-ref& rl-Vertex-Buffer make-rl-vertex-buffer
   copy-rl-vertex-buffer rl-vertex-buffer-set!
   rl-vertex-buffer-get rl-vertex-buffer-ref& Matrix
   make-matrix copy-matrix matrix-set! matrix-get matrix-ref&
   RL_CULL_FACE_FRONT RL_CULL_FACE_BACK
  ...
  (begin
    ...
    (define RL_DEFAULT_SHADER_ATTRIB_LOCATION_INSTANCETRANSFORM
      9)
    (define-ftype Matrix
      (struct
        [m-0 float]
