...
(do ([player-box (make-bounding-box (make-vector-3 0.0 0.0 0.0) (make-vector-3 0.0 0.0 0.0))]
     [enemy-box (make-bounding-box (make-vector-3 0.0 0.0 0.0) (make-vector-3 0.0 0.0 0.0))])
    ((window-should-close)
     (close-window))
  (cond
   [(is-key-down KEY_D)
