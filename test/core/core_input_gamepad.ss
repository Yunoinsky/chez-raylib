       ...
       (let ([gp-name (get-gamepad-name 0)])
         ...
         (case gp-name
           [("Xbox 360 Controller"
            ...
            (draw-rectangle 170 30 15 (int (* 70
                                              (/ (+ 1 (get-gamepad-axis-movement 0 GAMEPAD_AXIS_LEFT_TRIGGER))
                                                 2))) RED)
            (draw-rectangle 604 30 15 (int (* 70
                                              (/ (+ 1 (get-gamepad-axis-movement 0 GAMEPAD_AXIS_RIGHT_TRIGGER))
                                                 2))) RED)]
           ["PLAYSTATION(R)3 Controller"
            ...
            (let ([draw-key-circle
              ...
              (when (is-gamepad-button-down
                ...
                (draw-triangle (make-vector-2 436.0
                                              168.0)
                               (make-vector-2 436.0
                                              185.0)
                               (make-vector-2 464.0
              ...
              (draw-rectangle 169 48 15 (int (* 70
                                                (/ (+ 1 (get-gamepad-axis-movement 0 GAMEPAD_AXIS_LEFT_TRIGGER))
                                                   2))) RED)
              (draw-rectangle 611 48 15 (int (* 70
                                                (/ (+ 1 (get-gamepad-axis-movement 0 GAMEPAD_AXIS_RIGHT_TRIGGER))
                                                   2))) RED))]
